    ...
    Box(
        ...
        Canvas(modifier = Modifier.matchParentSize()) {
            val clipPath = Path().apply {
                lineTo(size.width - cutSize.toPx(), 0f)
                lineTo(size.width, cutSize.toPx())
            ...
            clipPath(clipPath) {
                ...
                drawRoundRect(
                    ...
                    topLeft = Offset(size.width - cutSize.toPx(), -100f),
                    size = Size(cutSize.toPx() + 100f, cutSize.toPx() + 100f),
                    cornerRadius = CornerRadius(cornerRadius.toPx())
                )
            }
        }
